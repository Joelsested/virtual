...
$query = $pdo->query("SELECT * FROM pacotes where $clausulaBusca ORDER BY id desc LIMIT $limite, $itens_pag");
...
for($i=0; $i < $total_reg; $i++){
    ...
    $query2 = $pdo->query("SELECT * FROM pacotes where $clausulaBusca ORDER BY id desc ");
