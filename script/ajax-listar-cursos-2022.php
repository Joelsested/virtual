...
$query = $pdo->query("SELECT * FROM cursos where status = 'Aprovado' and sistema = 'N?o' and ano = '2022' and $clausulaBusca ORDER BY id desc LIMIT $limite, $itens_pag");
...
for($i=0; $i < $total_reg; $i++){
    ...
    $query2 = $pdo->query("SELECT * FROM cursos where status = 'Aprovado' and sistema = 'N?o' and ano = '2022' and $clausulaBusca ORDER BY id desc " );
    ...
    $query2 = $pdo->query("SELECT * FROM cursos where status = 'Aprovado' and sistema = 'Não' and ano = '2022' and $clausulaBusca ORDER BY id desc ");
    $res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
    $total_reg2 = @count($res2);
