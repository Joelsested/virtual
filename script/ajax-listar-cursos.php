...
$query = $pdo->query("SELECT * FROM cursos where status = 'Aprovado' and sistema = 'Não' and $clausulaBusca ORDER BY id desc LIMIT $limite, $itens_pag");
...
for($i=0; $i < $total_reg; $i++){
    ...
    $query2 = $pdo->query("SELECT * FROM cursos where status = 'Aprovado' and sistema = 'Não' and $clausulaBusca ORDER BY id desc ");
