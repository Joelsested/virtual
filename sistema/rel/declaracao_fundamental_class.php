...
$html = utf8_encode(file_get_contents($url_sistema."sistema/rel/declaracao_fundamental.phpid=$id&data=$data_certificado&ano=$ano_certificado"));
...
//NOMEAR O PDF GERADO
$pdf->stream( ?? 'Declaração Fundamental.pdf',
