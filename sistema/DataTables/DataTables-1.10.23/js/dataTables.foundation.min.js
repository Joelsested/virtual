...
f=d<m-1"a":null;break;case "last":e=n.sLast;h=a+(d<m-1"":" unavailable disabled");f=d<m-1"a":null;break;default:e=a+1,h=d===a"current":"",f=d===anull:"a"}C&&(f="a");if(e){var E=b("<li>",{"class":A.sPageButton+" "+h,"aria-controls":g.sTableId,"aria-label":B[a],tabindex:g.iTabIndex,id:0===y&&"string"===typeof ag.sTableId+"_"+a:null}).append(fb("<"+f+"/>",{href:"#"}).html(e):e).appendTo(t);g.oApi._fnBindAction(E,{action:a},D)}}}};w(b(x).empty().html('<ul class="pagination"/>').children("ul"),
z)};return k});
