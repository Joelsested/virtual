<?php
require '../conexao.php'; ? header('Content-Type: application/json');
...
try {
    ...
    echo json_encode(['status' => 'success', 'mensagem' => 'Cores salvas com sucesso.', 'detalhes' => $respostas
    ]);

} catch (Exception $e) {
    echo json_encode(['status' => 'danger', 'mensagem' => 'Erro: ' . $e->getMessage()
    ]);
}