...
$query = $pdo->query("SELECT * FROM $tabela where vencimento >= '$dataInicial' and vencimento <= '$dataFinal' and descricao = 'Comissão' and pago = 'Não' and professor LIKE '$professor' ORDER BY id desc");
