...
for($i=0; $i < $total_reg; $i++){
	...
	$nome_curso = $res[$i]['curso'];	

	$query2 = $pdo->query("SELECT * FROM vendedores where id = '$professor'");
...
echo <<<HTML
<tr> 
	<td class="esc"><i class="fa fa-square {$classe_square}" style="margin-right:3px"></i>{$nome_professor}</td>			
	<td>{$descricao}</td> 
