...
$pathCertificateProd = __DIR__ . '/producao-517293-SESTED-EJA_cert.pem'; // Absolute path to the certificate in .pem or .p12 format
...
$pathCertificateHomolog = __DIR__ . '/homologacao-517293-SESTED-EJA-HOMO_cert.pem'; // Absolute path to the certificate in .pem or .p12 format
